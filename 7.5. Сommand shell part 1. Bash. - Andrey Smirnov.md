#7.5. Домашнее задание к занятию «Использование командных оболочек 1. Bash». - Андрей Смирнов.
...
fcount=$(stat -c '%F %s' * | grep 'file' | wc -l)
echo "В этой папке $dpath всего - $fcount файлов."
```


Результат работы скрипта:

![sshot7-5_2](img/7_5-2.jpg)
